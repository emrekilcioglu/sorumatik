...
import 'package:sorumatik/ui/pages/check_answers.dart';
            ...
            children: <Widget>[
              Card(
                ...
                child: ListTile(
                  ...
                  title: Text("Toplam Soru Sayısı", style: titleStyle),
                  trailing:
              ...
              Card(
                ...
                child: ListTile(
                  contentPadding: const EdgeInsets.all(16.0),
                  title: Text("Doğru Cevaplar", style: titleStyle),
              ...
              Card(
                ...
                child: ListTile(
                  contentPadding: const EdgeInsets.all(16.0),
                  title: Text("Yanlış Cevaplar", style: titleStyle),
                  trailing: Text(
