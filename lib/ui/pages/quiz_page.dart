...
import 'package:sorumatik/ui/pages/quiz_finished.dart';
  ...
  void _nextSubmit() {
    if (_answers[_currentIndex] == null) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text("Sonraki soruya geçebilmek için seçim yapmalısın"),
      ));
      return;
    }
  ...
  Future<bool> _onWillPop() async {
    final resp = await showDialog<bool>(
        ...
        builder: (_) {
          return AlertDialog(
            content: Text(
                "Quizden çıkmak istediğinize emin misin? Tüm ilerlemen kaybolacak."),
            title: Text("Uyarı!"),
            actions: <Widget>[
              TextButton(
                child: Text("Evet"),
